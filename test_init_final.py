	...
	async def on_message(msg):
		...
		if client.get_channel(channel) != msg.channel:
			...
			if message.content == command[16]:
				...
				embed.add_field(name='상아탑 1층', value='프라인 장로(3시간 30분)', inline=False)
				...
				embed.add_field(name='레토 리자드맨 부락', value='탈킨(4시간)', inline=False)
				...
				embed.add_field(name='산적 산채', value='발보(5시간)', inline=False)
				...
				embed.add_field(name='파아그리오의 제단', value='셀루(6시간)', inline=False)
