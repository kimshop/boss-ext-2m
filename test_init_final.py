		...
		if client.get_channel(channel) != msg.channel :
			...
			if message.content == '/젠':
				embed = discord.Embed(
						title='----- 보스 리젠 타임 -----',
						description= ' ')
				embed.add_field(name='2시간30분', value='브래카', inline=False)
				embed.add_field(name='3시간', value='체르투바,템페스트,펠리스', inline=False)
				embed.add_field(name='3시간30분', value='판나로드', inline=False)
				embed.add_field(name='4시간', value='바실라,엔쿠라,메두사,블랙릴리', inline=False)
				embed.add_field(name='4시간30분', value='마투라', inline=False)
				embed.add_field(name='5시간', value='켈소스,탈라킨,사르카', inline=False)
				embed.add_field(name='6시간', value='여왕개미,판드라이드,베히모스', inline=False)
				embed.add_field(name='7시간', value='스탄', inline=False)
				embed.add_field(name='8시간', value='티미트리스,크루마,오염된크루마', inline=False)
				embed.add_field(name='10시간', value='코어수스캡터,카탄', inline=False)
			...
			if message.content == '//':
				embed = discord.Embed(
						title='----- 보스 리젠 타임 -----',
						description= ' ')
				embed.add_field(name='브래카 소굴', value='브래카(2시간 30분)', inline=False)				
				embed.add_field(name='체르투바의 막사', value='체르투바(3시간)', inline=False)				
				embed.add_field(name='시체처리소', value='템페스트(3시간)', inline=False)				
				embed.add_field(name='비하이브', value='펠리스(3시간)', inline=False)				
				embed.add_field(name='고르곤의 화원', value='판나로드(3시간 30분)', inline=False)				
				embed.add_field(name='황무지 남부', value='바실라(4시간)', inline=False)
				embed.add_field(name='디온 목초지', value='엔쿠라(4시간)', inline=False)				
				embed.add_field(name='메두사의 정원', value='메두사(4시간)', inline=False)				
				embed.add_field(name='죽음의 회랑', value='블랙릴리(4시간)', inline=False)				
				embed.add_field(name='약탈자의 야영지', value='마투라(4시간 30분)', inline=False)				
				embed.add_field(name='절망의 폐허', value='켈소스(5시간)', inline=False)				
				embed.add_field(name='반란군 아지트', value='탈라킨(5시간)', inline=False)				
				embed.add_field(name='텔루 리자드맨 서식지', value='사르카(5시간)', inline=False)
				embed.add_field(name='개미굴 지하 3층', value='여왕개미(6시간)', inline=False)				
				embed.add_field(name='디온 구릉지', value='판드라이드(6시간)', inline=False)				
				embed.add_field(name='용의계곡 북부', value='베히모스(6시간)', inline=False)
				embed.add_field(name='거인의 흔적', value='스탄(7시간)', inline=False)				
				embed.add_field(name='플로란 개간지', value='티미트리스(8시간)', inline=False)				
				embed.add_field(name='크루마 습지', value='크루마(8시간)', inline=False)				
				embed.add_field(name='크루마탑 3층', value='오염된크루마(8시간)', inline=False)				
				embed.add_field(name='크루마탑 6층', value='카탄(10시간)', inline=False)
